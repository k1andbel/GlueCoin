UNIX BUILD NOTES
====================
Some notes on how to build Gluecoin Core in Unix.
...
memory available when compiling Gluecoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Gluecoin Core without wallet.
...
If you want to build Gluecoin-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Gluecoin Core distributions and independently built
