...
### Gluecoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Gluecoin Core for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/Gluecoin, ... but this will usually sort out itself
