...
The Gluecoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Gluecoin Core requires ZeroMQ API version 4.x or
...
using. Gluecoind appends an up-counting sequence number to each
